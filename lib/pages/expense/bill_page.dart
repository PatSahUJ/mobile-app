...
//   void initState() {
//     super.initState();
//     _fetchUsernames(); // Fetch usernames
//   }
...
//                         })
//                         .then((value) =>
//                             print("Transactions added to user ledger"))
//                         .catchError((error) =>
                  ...
                  if (user != null) {
                    ...
                    await FirebaseFirestore.instance
                        ...
                        .set({
                          ...
                          'comment': comment,
                          'category': category,
                          'payers': expenseProvider.payersData,
                          'bills': expenseProvider.billsAmounts,
                          'createdBy': user.uid,
                          'groupId': groupId,
                        })
                        .then((value) =>
